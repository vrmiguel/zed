...
impl ChannelMessage {
    pub async fn from_proto(
        ...
        let nonce = match message.nonce {
            ...
            None => {
                // Use a deterministic value based on message ID and timestamp to ensure
                // consistency if the same message is processed multiple times
